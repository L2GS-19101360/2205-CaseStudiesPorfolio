                ...
                <Navbar bg="light" data-bs-theme="light">
                    <Container>
                        ...
                        <Nav className="me-auto">
                            ...
                            <Nav.Link>
                                <Link to="/SustainableCitiesPage">CommuteSmart Case Study</Link>
                            </Nav.Link>
                        </Nav>
                    </Container>
                </Navbar>
                ...
                <div style={{ margin: "2%" }}>
                    ...
                    <Accordion>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header>Project Background</Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="3">
                            ...
                            <Accordion.Body>
                                ...
                                <img src={SamPersona} width={684} height={502} alt="" />&nbsp;
                                <img src={KennedyPersona} width={684} height={502} alt="" />
                                <p style={{ textAlign: 'justify', fontWeight: 'bold', marginTop: '10px' }}>Empathy Maps:
                                ...
                                <img src={SamMap} width={684} height={380} alt="" />&nbsp;
                                <img src={KennedyMap} width={684} alt="" />
                            </Accordion.Body>
                        </Accordion.Item>

                        <Accordion.Item eventKey="4">
                            <Accordion.Header>Ideation and Brainstorming</Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="6">
                            <Accordion.Header>User Testing</Accordion.Header>
                            <Accordion.Body>
                                ...
                                <img src={SamFlowchart} width={1284} alt="" />
                                <img src={KennedyFlowchart} width={1284} alt="" />
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="7">
                            <Accordion.Header>Iteration Design Process</Accordion.Header>
                            <Accordion.Body>
                                ...
                                <img src={VirutalFitTimeline} width={1400} alt="" />
                        ...
                        <Accordion.Item eventKey="8">
                            <Accordion.Header>Final Design Solutions</Accordion.Header>
                            <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="9">
                            <Accordion.Header>Impact and Results</Accordion.Header>
                            <Accordion.Body>
                                <ol>
                        ...
                        <Accordion.Item eventKey="10">
                            <Accordion.Header>Lessons Learned</Accordion.Header>
                            <Accordion.Body>
