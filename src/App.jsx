...
import { Button, Card, Nav, Container, Navbar } from 'react-bootstrap';
      ...
      <div id='TopPage'>
        ...
        <Navbar bg="light" data-bs-theme="light">
          <Container>
            ...
            <Nav className="me-auto">
              <Nav.Link href="#CaseStudiesCards">SDG Case Studies</Nav.Link>
        ...
        <div style={{ margin: "2%" }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <br />
            <h1 id='CaseStudiesCards'>Sustainable Development Goals Case Studies</h1>
            ...
            <h1 id='Developers'>SNAP InfoTechnovations Team and Developers</h1>
